    ...
    <section className="bg-base-100">
      <div className="max-w-5xl mx-auto px-8 py-16 md:py-32 ">
        <h2 className="text-center font-extrabold text-3xl md:text-5xl tracking-tight mb-12 md:mb-20">
          Tired of terrible YouTube subtitles and translations?
        </h2>

        <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-8 md:gap-12">
          <div className="bg-error/20 text-error p-8 md:p-12 rounded-lg w-full ">
            <h3 className="font-bold text-lg mb-4">
              Subtitles and Translations on YouTube
            </h3>

            <ul className="list-disc list-inside space-y-1.5 ">
              {/* Pains the user is experiencing by not using your product */}
              {[
                "Inaccurate and incorrect translations.",
                "Only offers subtitles in one language.",
                "Copy/paste vocabulary to a translator.",
                "Impossible to keep along with the video and subtitles.",
                "Subtitles break down with multiple speakers.",
              ].map((item, index) => (
          ...
          <div className="bg-success/20 text-success p-8 md:p-12 rounded-lg w-full">
            ...
            <ul className="list-disc list-inside space-y-1.5 ">
              ...
              {[
                "Near-perfect translations and subtitles via OpenAI and DeepL API's.",
                `Side-by-side subtitles in English and your target language for quick comparison.`,
                "Simply click on a word/character for an instant translation.",
                "A pointer that highlights the current word being spoken in the video.",
                "Handles multiple speakers perfectly.",
              ].map((item, index) => (
                <li key={index} className="flex gap-2 items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
